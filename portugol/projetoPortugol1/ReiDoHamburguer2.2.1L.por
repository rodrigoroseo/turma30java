		...
		enquanto(comprarSN == 'S' ou comprarSN == 's' e checarEstoque > 0){
			...
			faca{
				...
				se(estoque[produtoEscolhido] - qntdDigitada < 0){
					escreva("Produto fora de estoque. Por favor, escolha outro produto.")		//esse laço impede que o cliente peça mais do que tem no estoque
 ...
 * @POSICAO-CURSOR = 4684; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {estoque, 17, 10, 7}-{total, 22, 7, 5}-{carrinho, 23, 10, 8};
